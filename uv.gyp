  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'uvudt/dep/UDT4/src/api.cpp',
        'uvudt/dep/UDT4/src/buffer.cpp',
        'uvudt/dep/UDT4/src/cache.cpp',
        'uvudt/dep/UDT4/src/ccc.cpp',
        'uvudt/dep/UDT4/src/channel.cpp',
        'uvudt/dep/UDT4/src/common.cpp',
        'uvudt/dep/UDT4/src/udt_core.cpp',
        'uvudt/dep/UDT4/src/epoll.cpp',
        'uvudt/dep/UDT4/src/list.cpp',
        'uvudt/dep/UDT4/src/md5.cpp',
        'uvudt/dep/UDT4/src/packet.cpp',
        'uvudt/dep/UDT4/src/queue.cpp',
        'uvudt/dep/UDT4/src/udtc.cpp',
        'uvudt/dep/UDT4/src/window.cpp',
      ],
      'conditions': [
        [ 'OS=="win"', {
          'include_dirs': [
